...
if (isset($_POST["new_phones_atc"])) {
  $cart->addToCart($_POST["user_id"], $_POST["item_id"]);
}

?>
<!-- NEW PHONES SECTION -->
<section class="text-gray-700 body-font" id="new-phones-section">
  <div class="container px-5 py-24 mx-auto">
    ...
    <div class="">
      <div class="owl-carousel owl-theme relative" id="new-phones-carousel">
        <?php array_map(function ($item) { ?>
          <div class="p-4 mb-6 item product bg-gray-100 m-2 rounded-lg">
